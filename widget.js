...
cprequire_test(["inline:net-fka-ck-xyz"], function (xyz) {
    console.log("test running of " + xyz.id);
    //sp.init("192.168.1.7");
    //xyz.initAs3dPrinting();
    xyz.init();
    xyz.showBody("net-fka-ck-xyz");
    xyz.currentUnits = 'mm'
    ...
    setTimeout(function() {
        ...
        $('#net-fka-ck-xyz-ftr').keydown(function(evt) {
            var e = $.Event('keydown');
...
cpdefine("inline:net-fka-ck-xyz", ["chilipeppr_ready", "jquerycookie"], function () {
    return {
        id: "net-fka-ck-xyz",
        ...
        pencilSetup: function() {
            ...
            //$('#net-fka-ck-xyz-x').mouseover(this.pencilOnMouseover.bind(this));
            //$('#net-fka-ck-xyz-x').mouseout(this.pencilOnMouseout.bind(this));
            $('#net-fka-ck-xyz-x').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
            $('#net-fka-ck-xyz-y').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
            $('#net-fka-ck-xyz-z').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
            $('#net-fka-ck-xyz-a').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
        },
        ...
        initAs3dPrinting: function () {
            ...
            $('#net-fka-ck-xyz-a').removeClass("hidden");
            $('#net-fka-ck-xyz-b').removeClass("hidden");
            // change labels
            $('#net-fka-ck-xyz-a .com-chilipeppr-xyz-label').text("E0");
            $('#net-fka-ck-xyz-b .com-chilipeppr-xyz-label').text("E1");
            // change units
            $('#net-fka-ck-xyz-a .com-chilipeppr-xyz-dim').text("mm");
            $('#net-fka-ck-xyz-b .com-chilipeppr-xyz-dim').text("mm");

        },
        setupShowHideWcsBtn: function () {

            var btnEl = $("#net-fka-ck-xyz .btnToggleShowWcs");
        ...
        toggleWcs: function (evt) {
            $("#net-fka-ck-xyz .btnToggleShowWcs").popover('hide');
            var wcsEl = $('#com-chilipeppr-widgetholder-wcs');
            if (wcsEl.hasClass("hidden")) {
                wcsEl.removeClass("hidden");
                $('#net-fka-ck-xyz .btnToggleShowWcs').addClass("active");
            } else {
                wcsEl.addClass("hidden");
                $('#net-fka-ck-xyz .btnToggleShowWcs').removeClass("active");

            }
        },
        setupShowHideTouchBtn: function () {
            $("#net-fka-ck-xyz .btnToggleShowTouchJog").popover();
        ...
        showHideTouchBtn: function () {
            ...
            var btnEl = $("#net-fka-ck-xyz .btnShowTouchJog");
            var btnParentWidth = btnEl.parent().parent().width();
            var widgetWidth = $("#net-fka-ck-xyz").width();
        ...
        setupTouchArea: function () {
            this.canvas = $('#net-fka-ck-xyz .touchpad-overlay canvas');
            var tpad = $('#net-fka-ck-xyz .touchpad-overlay');
            ...
            this.canvas.prop({
                ...
                */
            this.el = $('#net-fka-ck-xyz .touchpad-overlay canvas')[0];
            this.canvasResize();
            //this.ctx = $('#net-fka-ck-xyz .touchpad-overlay canvas')[0].getContext("2d");
            var that = this;
            ...
            */
            ...
            $('#net-fka-ck-xyz .btnToggleShowTouchJog').click(this.toggleTouchJog.bind(this));
        ...
        toggleTouchJog: function () {
            $('#net-fka-ck-xyz .btnToggleShowTouchJog').popover('hide');
            var tpad = $('#net-fka-ck-xyz .touchpad-overlay');
            if (tpad.hasClass("hidden")) {
                tpad.removeClass("hidden");
                this.canvasResize();
                $('#net-fka-ck-xyz .btnToggleShowTouchJog').addClass("active");
            } else {
                tpad.addClass("hidden");
                $('#net-fka-ck-xyz .btnToggleShowTouchJog').removeClass("active");
        ...
        toolbarSetup: function () {
            ...
            var that = this;
            $('#net-fka-ck-xyz .view-small').click(function () {
                that.bodyShowSmall();
                localStorage.setItem("/" + that.id + "/size", "small");
            });
            $('#net-fka-ck-xyz .view-large').click(function () {
                that.bodyShowNormal();
                localStorage.setItem("/" + that.id + "/size", "normal");
            });
        },
        bodyShowSmall: function () {
            $('#net-fka-ck-xyz').addClass("size-small");
            $('#net-fka-ck-xyz .view-small').addClass("active");
            $('#net-fka-ck-xyz .view-large').removeClass("active");
        },
        bodyShowNormal: function () {
            $('#net-fka-ck-xyz').removeClass("size-small");
            $('#net-fka-ck-xyz .view-small').removeClass("active");
            $('#net-fka-ck-xyz .view-large').addClass("active");
        },
        options: null,
        setupUiFromCookie: function () {
            // read vals from cookies
            var options = $.cookie('net-fka-ck-xyz-options');
        ...
        saveOptionsCookie: function () {
            ...
            // store cookie
            $.cookie('net-fka-ck-xyz-options', optionsStr, {
                expires: 365 * 10,
                path: '/'
            });
        },
        ...
        onPlannerPause: function () {
            ...
            if (this.pauseBtnIcon === null) this.pauseBtnIcon = $('#net-fka-ck-xyz div.plannerpause');
        ...
        */
        ...
        onCoordsUpdate: function (coords) {
            ...
            if (coords.coordNum != this.lastCoords.coordNum) {
                $('.net-fka-ck-xyz-coords').text(coords.coord);
        ...
        setupAxes: function () {
            this.axisx = {
                intblack: $('#net-fka-ck-xyz-x .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-x .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-x .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-x .xyz-decimal')
            };
            this.axisy = {
                intblack: $('#net-fka-ck-xyz-y .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-y .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-y .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-y .xyz-decimal')
            };
            this.axisz = {
                intblack: $('#net-fka-ck-xyz-z .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-z .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-z .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-z .xyz-decimal')
            };
            this.axisa = {
                intblack: $('#net-fka-ck-xyz-a .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-a .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-a .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-a .xyz-decimal')
            };
            this.axismx = {
                intblack: $('#net-fka-ck-xyz-mx .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-mx .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-mx .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-mx .xyz-decimal')
            };
            this.axismy = {
                intblack: $('#net-fka-ck-xyz-my .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-my .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-my .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-my .xyz-decimal')
            };
            this.axismz = {
                intblack: $('#net-fka-ck-xyz-mz .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-mz .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-mz .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-mz .xyz-decimal')
            };
            this.axisma = {
                intblack: $('#net-fka-ck-xyz-ma .xyz-intblack'),
                intgray: $('#net-fka-ck-xyz-ma .xyz-intgray'),
                negpos: $('#net-fka-ck-xyz-ma .xyz-negpos'),
                decimal: $('#net-fka-ck-xyz-ma .xyz-decimal')
            };
            this.axes = {
                x: this.axisx,
                y: this.axisy,
        ...
        menuSetup: function () {
            $('#net-fka-ck-xyz .xyz-showa').click(this.showHideAxisA.bind(this));
            $('#net-fka-ck-xyz .showhideaaxis').click(this.showHideAxisA.bind(this));
            $('#net-fka-ck-xyz .showhidemDRO').click(this.showHidemDRO.bind(this));

            // Setup zeroing G92 - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(0).click("x", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(0).click("y", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(0).click("z", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(0).click("a", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');;

            // Setup unzeroing G92 - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(1).click("x", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(1).click("y", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(1).click("z", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(1).click("a", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');;

            // Setup goto Work zero - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(2).click("x", this.gotoZero.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(2).click("y", this.gotoZero.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(2).click("z", this.gotoZero.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(2).click("a", this.gotoZero.bind(this)).prop('href', 'javascript:');

            // Setup zeroing G10 (work) - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(3).click("mx", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(3).click("my", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(3).click("mz", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(3).click("ma", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');;

            // Setup goto Machine zero - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(4).click("x", this.gotoZeroM.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(4).click("y", this.gotoZeroM.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(4).click("z", this.gotoZeroM.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(4).click("a", this.gotoZeroM.bind(this)).prop('href', 'javascript:');

            // Setup homing with no limit switches - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(5).click("x", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(5).click("y", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(5).click("z", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(5).click("a", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');;

            // Setup homing with limit switches - per axis menu
            $('#net-fka-ck-xyz-x .dropdown-menu a').eq(6).click("x", this.homeAxis.bind(this)).prop('href', 'javascript:');
            $('#net-fka-ck-xyz-y .dropdown-menu a').eq(6).click("y", this.homeAxis.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-z .dropdown-menu a').eq(6).click("z", this.homeAxis.bind(this)).prop('href', 'javascript:');;
            $('#net-fka-ck-xyz-a .dropdown-menu a').eq(6).click("a", this.homeAxis.bind(this)).prop('href', 'javascript:');;
        ...
        showHideAxisA: function () {
            var el = $('#net-fka-ck-xyz-a');
            if (el.hasClass('hidden')) {
                this.isAAxisShowing = true;
                el.removeClass('hidden');
                $('#net-fka-ck-xyz .showhideaaxis').addClass("active");
            } else {
                this.isAAxisShowing = false;
                el.addClass('hidden');
                $('#net-fka-ck-xyz .showhideaaxis').removeClass("active");
            }
            $(window).trigger('resize');
        },
        ismDROShowing: false,
        showHidemDRO: function () {
            var el = $('#net-fka-ck-xyz-mx');
            if ($('#net-fka-ck-xyz-mx').hasClass('hidden')) {
                this.ismDROShowing = true;
                $('#net-fka-ck-xyz-mx').removeClass('hidden');
                $('#net-fka-ck-xyz-my').removeClass('hidden');
                $('#net-fka-ck-xyz-mz').removeClass('hidden');
                $('#net-fka-ck-xyz .showhidemDRO').addClass("active");
            } else {
                this.ismDROShowing = false;
                $('#net-fka-ck-xyz-mx').addClass('hidden');
                $('#net-fka-ck-xyz-my').addClass('hidden');
                $('#net-fka-ck-xyz-mz').addClass('hidden');
                $('#net-fka-ck-xyz .showhidemDRO').removeClass("active");
            }
            $(window).trigger('resize');
        },
        btnSetup: function () {
            // setup planner indicator icon
            $('#net-fka-ck-xyz div.plannerpause').popover({
                html: true,
                delay: 200,
                animation: true,
                trigger: 'hover',
            ...
            // in / mm
            $('#net-fka-ck-xyz .btnInMm').click(this.toggleInMm.bind(this));

            $('#net-fka-ck-xyz .showhidemDRO').popover();
            $('#net-fka-ck-xyz .showhideaaxis').popover();
            $('#net-fka-ck-xyz .btnInMm').popover();
            $('#net-fka-ck-xyz .btnmachineDRO').popover();
        },
        jogFocusIndicate: function () {
            $('#net-fka-ck-xyz').addClass("panel-primary");
        },
        jogFocusUnindicate: function () {
            $('#net-fka-ck-xyz').removeClass("panel-primary");
        },
        ...
        customMenuSetVal: function (itemNum) {
            ...
            var inputEl = $('#net-fka-ck-xyz-ftr ' + cls);
            var val = parseFloat(inputEl.val());
            if (val != null) {
                $('#net-fka-ck-xyz-ftr .jogincrCustomVal').text(val);
                this.changeBaseVal({
                    data: {
                        newval: val,
            ...
            } else $('#net-fka-ck-xyz-ftr .jogincrCustomVal').text("-");
        },
        jogSetup: function () {
            // attach to focus and blur events
            // when focused, we'll jog
            var that = this;
            $('#net-fka-ck-xyz-jog').popover();
            $('#net-fka-ck-xyz-ftr .btn').popover();


            // setup button events
            $('#net-fka-ck-xyz-ftr .jogx').click("X+", this.jogBtn.bind(this));
            $('#net-fka-ck-xyz-ftr .jogy').click("Y+", this.jogBtn.bind(this));
            $('#net-fka-ck-xyz-ftr .jogz').click("Z+", this.jogBtn.bind(this));
            $('#net-fka-ck-xyz-ftr .jogxneg').click("X-", this.jogBtn.bind(this));
            $('#net-fka-ck-xyz-ftr .jogyneg').click("Y-", this.jogBtn.bind(this));
            $('#net-fka-ck-xyz-ftr .jogzneg').click("Z-", this.jogBtn.bind(this));

            //gotoZero
            $('#net-fka-ck-xyz-ftr .joggotozerow').click("xyz", this.gotoZero.bind(this));
            $('#net-fka-ck-xyz-ftr .jogzerooutw').click("xyz", this.zeroOutAxisG10.bind(this));
            $('#net-fka-ck-xyz-ftr .joghomem').click("xyz", this.homeAxis.bind(this));
            $('#net-fka-ck-xyz-ftr .joggotozerom').click("xyz", this.gotoZeroM.bind(this));
            $('#net-fka-ck-xyz-ftr .jogzerooutm').click("xyz", this.zeroOutAxisG28.bind(this));


            // setup base value increment buttons
            $('#net-fka-ck-xyz-ftr .jogincr1').click({
                newval: 1.0,
                cls: ".jogincr1"
            }, this.changeBaseVal.bind(this));
            $('#net-fka-ck-xyz-ftr .jogincrpt1').click({
                newval: 0.1,
                cls: ".jogincrpt1"
            }, this.changeBaseVal.bind(this));
            $('#net-fka-ck-xyz-ftr .jogincrpt01').click({
                newval: 0.01,
                cls: ".jogincrpt01"
            }, this.changeBaseVal.bind(this));
            $('#net-fka-ck-xyz-ftr .jogincrpt001').click({
                newval: 0.001,
                cls: ".jogincrpt001"
            }, this.changeBaseVal.bind(this));

            // setup custom increment button
            var custIncrBtn = $('#net-fka-ck-xyz-ftr .jogincrCustomBtn');
            custIncrBtn.click(function () {
                var txt = $('#net-fka-ck-xyz-ftr .jogincrCustomVal').text();
                if (txt != "-") {
            ...
            var custDropUpBtn = $('#net-fka-ck-xyz-ftr .jogincrCustomDropUpBtn');
            custDropUpBtn.on('click', function () {
                console.log("drop up btn clicked");
                that.isInCustomMenu = true;
                //$('#net-fka-ck-xyz-ftr').blur();
            });

            // show/ hide.bs.dropdown
            var custMenu = $('#net-fka-ck-xyz-ftr .jogincrCustomDropUpMenu').parent();
            ...
            var custInput = $('#net-fka-ck-xyz-ftr .jogincrCustomInput');
            ...
            $('#net-fka-ck-xyz-ftr .jogincrCustomSet1').click(1, this.customMenuSetVal.bind(this));
            $('#net-fka-ck-xyz-ftr .jogincrCustomSet2').click(2, this.customMenuSetVal.bind(this));
            $('#net-fka-ck-xyz-ftr .jogincrCustomSet3').click(3, this.customMenuSetVal.bind(this));
            $('#net-fka-ck-xyz-ftr .jogincrCustomSet4').click(4, this.customMenuSetVal.bind(this));

            // setup jog btn
            $('#net-fka-ck-xyz-jog').click(function () {
                console.log("setting focus/blur to footer");
                var elFtr = $('#net-fka-ck-xyz-ftr');
                //if ($('#net-fka-ck-xyz').hasClass('panel-primary'))
                //    elFtr.blur();
                //else
                elFtr.focus();
            });
            ...
            $('#net-fka-ck-xyz-ftr').focusin(function () {
                ...
                $('#net-fka-ck-xyz').addClass("panel-primary");
                $('#net-fka-ck-xyz-ftr').addClass("panel-primary");
                isjogging = true;
                that.accelBaseValHilite({});
                console.log("got focusin on axes widget ftr");
            });
            $('#net-fka-ck-xyz-ftr').focusout(function () {

                //console.log("jog area blur");
                $('#net-fka-ck-xyz').removeClass("panel-primary");
                $('#net-fka-ck-xyz-ftr').removeClass("panel-primary");
                isjogging = false;
                that.accelBaseValHilite({});
                console.log("got focusout on axes widget ftr");
            });
            /*$('#net-fka-ck-xyz-ftr').keypress(function (evt) {
            ...
            $('#net-fka-ck-xyz-ftr').keydown(function (evt) {
                ...
                */
                ...
                if (key == 38) {
                    // up arrow. Y+
                    direction = "Y+";
                    $('#net-fka-ck-xyz-ftr .jogy').addClass("hilite");
                } else if (key == 40) {
                    // down arrow. Y-
                    direction = "Y-";
                    $('#net-fka-ck-xyz-ftr .jogyneg').addClass("hilite");
                } else if (key == 37) {
                    direction = "X-";
                    $('#net-fka-ck-xyz-ftr .jogxneg').addClass("hilite");
                } else if (key == 39) {
                    direction = "X+";
                    $('#net-fka-ck-xyz-ftr .jogx').addClass("hilite");
                } else if (key == 33) {
                    // page up
                    direction = "Z+";
                    $('#net-fka-ck-xyz-ftr .jogz').addClass("hilite");
                } else if (key == 34) {
                    // page down
                    direction = "Z-";
                    $('#net-fka-ck-xyz-ftr .jogzneg').addClass("hilite");
                }
            ...
            $('#net-fka-ck-xyz-ftr').keyup(function (evt) {
                ...
                if (key == 38) {
                    // up arrow. Y+
                    $('#net-fka-ck-xyz-ftr .jogy').removeClass("hilite");
                } else if (key == 40) {
                    // down arrow. Y-
                    $('#net-fka-ck-xyz-ftr .jogyneg').removeClass("hilite");
                } else if (key == 37) {
                    $('#net-fka-ck-xyz-ftr .jogxneg').removeClass("hilite");
                } else if (key == 39) {
                    $('#net-fka-ck-xyz-ftr .jogx').removeClass("hilite");
                } else if (key == 33) {
                    // page up
                    $('#net-fka-ck-xyz-ftr .jogz').removeClass("hilite");
                } else if (key == 34) {
                    // page down
                    $('#net-fka-ck-xyz-ftr .jogzneg').removeClass("hilite");
                }
        ...
        accelBaseValHilite: function (evt) {
            ...
            $('#net-fka-ck-xyz-ftr .jogincrements-horiz button').removeClass("hiliteblue");

            if (isCustom) {
                // just tweak the val in red <code> instead of hiliting button
                $('#net-fka-ck-xyz-ftr .jogincrCustomBtn').addClass("hiliteblue");
                this.customOrigVal = this.baseval;
                $('#net-fka-ck-xyz-ftr .jogincrCustomVal').text(accelval);
            } else {
                this.customOrigVal = null;
                //$('#net-fka-ck-xyz-ftr .btnincrements button').removeClass("hiliteblue");
                if (accelval == 1.0) $('#net-fka-ck-xyz-ftr .jogincr1').addClass("hiliteblue");
                if (accelval == 0.1) $('#net-fka-ck-xyz-ftr .jogincrpt1').addClass("hiliteblue");
                if (accelval == 0.01) $('#net-fka-ck-xyz-ftr .jogincrpt01').addClass("hiliteblue");
                if (accelval == 0.001) $('#net-fka-ck-xyz-ftr .jogincrpt001').addClass("hiliteblue");
            }
        },
        accelBaseValUnhilite: function () {
            ...
            if (this.customOrigVal != null) {
                ...
                this.customOrigVal = null;
                $('#net-fka-ck-xyz-ftr .jogincrCustomVal').text(this.baseval);
            }
        ...
        changeBaseVal: function (evt) {
            ...
            this.accelBaseval = this.baseval;
            // reset all hilites
            $('#net-fka-ck-xyz-ftr .jogincrements-horiz button').removeClass("hilite");
            $('#net-fka-ck-xyz-ftr .jogincrements-horiz button').removeClass("hiliteblue");
            //$('#net-fka-ck-xyz-ftr .btnincrements button').removeClass("hilite");
            // set new hilite
            $('#net-fka-ck-xyz-ftr ' + evt.data.cls).addClass("hilite");
        ...
        forkSetup: function () {
            //$('#net-fka-ck-xyz-tbar-fork').prop('href', this.fiddleurl);
            //$('#net-fka-ck-xyz-tbar-standalone').prop('href', this.url);
            //$('#net-fka-ck-xyz .fork-name').html(this.id);
            $('#net-fka-ck-xyz .panel-title').popover({
                title: this.name,
                content: this.desc,
                trigger: 'hover',
                placement: "auto",
            ...
            chilipeppr.load("http://fiddle.jshell.net/chilipeppr/zMbL9/show/light/", function () {
                require(['inline:com-chilipeppr-elem-pubsubviewer'], function (pubsubviewer) {
                    pubsubviewer.attachTo($('#net-fka-ck-xyz .panel-heading .dropdown-menu'), that);
                });
            });
